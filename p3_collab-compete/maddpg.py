# https://github.com/Rafael1s/Deep-Reinforcement-Learning-Udacity/blob/master/Project-3_Collaboration_Competition-Tennis-Maddpg/maddpg_agent.py
import copy
import os
import random
...
class maddpg_agent:
    ...
    def __init__(self, num_agents=2, state_size=24, action_size=2, random_seed=8):
    ...
    def learn(self, experiences, agent_number):
        ...
        agent.learn(experiences, GAMMA, next_actions, actions_pred)
